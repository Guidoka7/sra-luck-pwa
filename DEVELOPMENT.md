...
Nenhum deploy de produção é realizado por este fluxo automaticamente pelo assistente. A promoção para `main` deve ocorrer somente após aprovação explícita.
