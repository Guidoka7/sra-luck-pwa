        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <TableHead className="text-center">Pagas / Pend / Atr</TableHead>
            ...
            {filtered.map((r) => (
              <TableRow key={r.id} className="hover:bg-slate-50/60">
                <TableCell>
                  ...
                  <div className="text-[11px] text-slate-500">{formatCPF(r.cpf)} · {r.contrato}</div>
                </TableCell>
                ...
                <TableCell className="text-center text-sm">
                  <span className="text-emerald-700">{r.pagas}</span> · <span className="text-amber-700">{r.pendentes}</span> · <span className="text-rose-700">{r.atrasadas}</span>
                </TableCell>
                ...
                <TableCell>
                  <NavLink
                    to={`/admin/financeiro/clientes/${r.id}`}
