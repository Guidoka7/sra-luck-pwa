  ...
  return (
    <div className="admin-shell admin-compact min-h-screen bg-bloom dark:bg-[#0b0a0c]">
      ...
      <div className="relative flex min-h-screen w-full">
        ...
        <aside className={cn("fixed inset-y-0 left-0 z-50 flex w-[272px] flex-col border-r border-rose/10 bg-white/92 px-4 py-4 text-clay shadow-[0_30px_100px_-40px_rgba(122,38,50,0.28)] backdrop-blur-2xl transition-transform duration-300 ease-out dark:border-white/8 dark:bg-[#151317]/96 dark:text-[#e8dcda] dark:shadow-[0_30px_90px_-28px_rgba(0,0,0,0.72)]", "lg:translate-x-0", menuAberto ? "translate-x-0" : "-translate-x-full")}>
          <div className="flex min-h-0 flex-1 flex-col">
            <div className="flex items-center justify-between border-b border-rose/10 pb-4 dark:border-white/8">
              <div className="min-w-0 flex-1"><Wordmark maxWidth={164} /><p className="mt-1.5 text-[9px] font-medium uppercase tracking-[0.28em] text-burgundy/45 dark:text-[#cda5a2]/58">Sistema empresarial</p></div>
