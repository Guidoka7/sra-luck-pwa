...
export default function ParcelasPage() {
  ...
  return <div className="space-y-4 pb-8">
    ...
    {!clienteId ? <Panel className="p-10 text-center"><UserRound className="mx-auto h-8 w-8 text-burgundy/15" /><p className="mt-3 font-heading text-lg text-burgundy">Pesquise uma cliente para começar</p><p className="mt-1 text-sm text-clay/45">O carnê e as ferramentas de gestão aparecem somente depois da seleção.</p></Panel> : <>
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4"><Resumo label="Total" valor={boletos.length} /><Resumo label="Pagas" valor={pagas} destaque /><Resumo label="Em aberto" valor={abertas} /><Resumo label="Realocadas" valor={suspensas} /></div>
      <Panel className="p-4 sm:p-5">
