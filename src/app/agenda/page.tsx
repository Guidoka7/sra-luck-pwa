...
export default function AgendaClientePage() {
  ...
  return <main className="client-app min-h-[100dvh] bg-bloom px-4 pb-[max(env(safe-area-inset-bottom),1rem)] pt-[max(env(safe-area-inset-top),0.75rem)] sm:px-6 sm:pt-6 sm:pb-8">
    ...
    <div className="mobile-app-frame mx-auto w-full max-w-2xl sm:max-w-[30rem]">
      ...
      <div className="mb-4"><JourneyTracker percentualPagamento={porcentagemPagamento ?? 0} percentualAtingido={podeAgendar} statusRevisao={statusRevisao} agendada={Boolean(agendamentoAtivo)} /></div>
