...
export function CicloLiberacaoFinanceiraV2() {
  ...
  const solicitacaoSelecionada = useMemo(() => solicitacoes.find(s => s.cliente_id === selecionada?.clienteId && ["pendente","em_analise","aprovada"].includes(s.status)) ?? null, [solicitacoes,selecionada]);
