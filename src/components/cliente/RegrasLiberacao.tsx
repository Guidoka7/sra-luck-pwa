    ...
    <div className="rounded-2xl border border-rose/15 bg-white/70 p-3.5 shadow-sm sm:p-4">
      ...
      >
        <span className="flex items-center gap-2">
          <span className="flex h-7 w-7 flex-none items-center justify-center rounded-full bg-burgundy/10">
            <ScrollText className="h-3.5 w-3.5 text-burgundy" />
          </span>
          <span className="text-[0.8rem] font-semibold text-burgundy">
          ...
          >
            <div className="mt-3 space-y-3 border-t border-rose/10 pt-3">
              {regraDoContrato && parcelasNecessarias ? (
                <div className="relative overflow-hidden rounded-xl border border-gold/25 bg-gradient-to-br from-burgundy via-burgundy to-burgundy-dark p-4 text-cream shadow-card">
                  ...
                  <p className="relative flex items-center gap-2 text-[0.6rem] font-semibold uppercase tracking-label text-gold/85">
                  ...
                  <div className="relative mt-3 grid grid-cols-2 gap-2.5">
                    <div className="rounded-lg border border-white/10 bg-white/[0.06] px-3 py-2.5">
                      <p className="font-heading text-2xl font-semibold leading-none">
                        ...
                        <span className="text-lg text-cream/60">x</span>
                      </p>
                      <p className="mt-1 text-[0.65rem] leading-tight text-cream/60">parcelas contratadas</p>
                    </div>
                    <div className="rounded-lg border border-gold/25 bg-gold/[0.08] px-3 py-2.5">
                      <p className="font-heading text-2xl font-semibold leading-none text-gold">
                        {regraDoContrato.percentual}
                        <span className="text-lg text-gold/70">%</span>
                      </p>
                      <p className="mt-1 text-[0.65rem] leading-tight text-cream/60">para liberar a agenda</p>
                    </div>
                  </div>

                  <div className="relative mt-2.5 flex items-center gap-2.5 rounded-lg border border-white/10 bg-white/[0.07] px-3 py-2.5">
                    <span className="flex h-7 w-7 flex-none items-center justify-center rounded-full bg-gold/20">
                      <span className="font-heading text-xs font-bold text-gold">{parcelasNecessarias}</span>
                    </span>
                    <p className="text-[0.8rem] leading-snug text-cream/90">
                ...
                <p className="text-[0.8rem] text-clay/60">As regras do seu contrato aparecerão aqui assim que as parcelas forem cadastradas.</p>
              )}

              <p className="text-[0.8rem] leading-relaxed text-clay/70">
