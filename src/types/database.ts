...
export interface Boleto { id: string; cliente_id: string; numero_parcela: number; total_parcelas: number; valor: number; data_vencimento: string | null; status: StatusBoleto; comprovante_url: string | null; data_pagamento: string | null; observacoes: string | null; suspensa?: boolean; suspensa_em?: string | null; suspensa_por?: string | null; created_at: string; updated_at: string; clientes?: { id: string; nome_completo: string; cpf: string }; }
