...
export type CargoColaborador = "vendedora" | "sdr" | "financeiro" | "administrativo";
...
export interface Cliente { id: string; nome_completo: string; cpf: string; data_nascimento: string; telefone: string | null; email: string | null; procedimento: string | null; medico: string | null; hospital: string | null; consultora: string | null; vendedora_id?: string | null; valor_contrato: number; taxa_administrativa_percentual: number; custo_total: number; status_cirurgia: StatusCirurgia; status_financeiro: StatusFinanceiro; quantidade_parcelas: QuantidadeParcelas | null; percentual_minimo_agendar?: number | null; porcentagem_pagamento?: number | null; parcelas_pagas?: number | null; parcelas_total?: number | null; status_revisao_financeira?: StatusRevisaoFinanceira | null; data_atingiu_percentual?: string | null; observacao_revisao_financeira?: string | null; financeiro_saldo_restante?: number | null; financeiro_taxa_cartao?: number | null; financeiro_total_com_taxa?: number | null; financeiro_formas_custeio?: FormaCusteioRestante[] | null; financeiro_confirmado_em?: string | null; custeio_confirmado_em?: string | null; termos_assinados_em?: string | null; proximo_agendamento_data?: string | null; proximo_agendamento_horario?: string | null; observacoes_internas?: string | null; ativo?: boolean; }
...
export interface Agendamento { id: string; cliente_id: string; data_id: string; valor_contrato: number; status: StatusAgendamento; sdr_id?: string | null; comparecimento_status?: StatusComparecimento | null; comparecimento_em?: string | null; observacoes_internas: string | null; previsao_liberacao_financeira: string | null; horario_termos?: string | null; termos_assinados_em?: string | null; created_at: string; updated_at: string; }
...
export interface NovaVenda { id: string; rd_station_id: string; cliente_id: string | null; nome_completo: string; cpf: string | null; telefone: string | null; email: string | null; data_venda: string; vendedora_responsavel: string | null; vendedora_id?: string | null; valor_contrato: number; quantidade_parcelas: number | null; valor_parcela: number | null; taxa_administrativa: number | null; tipo_venda: string | null; origem_venda: string | null; status: StatusNovaVenda; payload_original?: Record<string, unknown> | null; created_at: string; updated_at: string; }
export interface Colaborador { id: string; auth_user_id: string; nome: string; email: string; cargo: CargoColaborador; ativo: boolean; permissoes: string[]; }
export interface Comissao { id: string; colaborador_id: string; cargo: CargoColaborador; cliente_id: string | null; agendamento_id: string | null; boleto_id: string | null; evento: string; chave_evento: string; valor: number; status: "pendente" | "aprovada" | "paga"; created_at: string; pago_em: string | null; }
