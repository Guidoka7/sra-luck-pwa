...
export const STATUS_CONCILIACAO_LABEL: Record<StatusConciliacaoPagamento, string> = { pendente: "Pendente de conciliação", conciliado: "Conciliado", nao_identificado: "Não identificado", divergencia: "Divergência", ignorado: "Ignorado" };
export const STATUS_CONCILIACAO_TONE: Record<StatusConciliacaoPagamento, "neutral" | "success" | "alert" | "gold"> = { pendente: "gold", conciliado: "success", nao_identificado: "alert", divergencia: "alert", ignorado: "neutral" };
